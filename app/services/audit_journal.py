...
FIELD_WHITELISTS = {
    ...
    "category": {"name"},
    "inventory": {"stock"},
    "repair": {"archive_status", "archived_at", "archived_by", "source_repair_id", "responsible_user_id"},
    "order": {"status", "tracking", "comment", "customer", "responsible_user_id"},
    "customer": {"name", "phone", "email", "comment", "responsible_user_id"},
