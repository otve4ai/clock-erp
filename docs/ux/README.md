...
Форма ремонта не загружает ассортимент при открытии: поиск товара начинается
после двух символов с debounce 300 мс, отменяет предыдущий запрос и показывает
не более 20 результатов с отдельными loading/empty/error состояниями. При
редактировании сохранённый товар сразу показывается из snapshot ремонта.
...
Товарная страница не встраивает полные списки брендов и категорий в каждый
combobox: доступные значения загружаются теми же catalog endpoints при открытии
или поиске, а выбранные значения восстанавливаются по ID и подписи.
