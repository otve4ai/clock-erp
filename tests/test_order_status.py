...
class OrderStatusFrontendContractTests(unittest.TestCase):
    def test_orders_template_has_exact_status_actions_and_mobile_layout(self):
        ...
        self.assertIn('order_status_counts.keys()', template)
        self.assertIn('data-status-more', template)
        self.assertNotIn('data-primary-statuses', template)
        ...
        self.assertIn("while(requested!==saved)", template)
